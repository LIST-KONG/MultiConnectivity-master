...
class MultiHeadAttentionLayer(nn.Module):
    ...
    def forward(self, g, fc_h, sc_h, e):
...
class GraphTransformer_Multimodal_fc_Layer(nn.Module):
    """
        Param:
    """
    ...
    def forward(self, fc_g, fc_h, sc_h, e):
        h_in1 = fc_h  # for first residual connection
        e_in1 = e  # for first residual connection

        # multi-head attention out
        h_attn_out, e_attn_out = self.attention(fc_g, fc_h, sc_h, e)
