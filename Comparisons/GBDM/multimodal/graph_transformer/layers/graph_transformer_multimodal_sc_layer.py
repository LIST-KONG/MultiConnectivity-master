...
class MultiHeadAttentionLayer(nn.Module):
    ...
    def forward(self, g, sc_h, fc_h, e):
...
class GraphTransformer_Multimodal_sc_Layer(nn.Module):
    """
        Param:
    """
    ...
    def forward(self, sc_g, sc_h, fc_h, e):
        h_in1 = sc_h  # for first residual connection
        e_in1 = e  # for first residual connection

        # multi-head attention out
        h_attn_out, e_attn_out = self.attention(sc_g, sc_h, fc_h, e)
