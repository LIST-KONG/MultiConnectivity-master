...
from singlemodal.GCN import GCN as GCN_single
from GCN import GCN
...
parser.add_argument('--dataset', type=str, default='multi_SCFC', help="XX_SCFC/ZD_SCFC/multi_SCFC")
...
parser.add_argument('--bandwidth', type=int, default=2, help="bandwidth parameter of Gaussian kernel")
...
if __name__ == '__main__':
    ...
    # random_s = np.array([50], dtype=int)
