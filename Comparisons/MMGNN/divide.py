...
def kfold_split(self, test_index, args):
    ...
    val_loader = DataLoader(valid_subset, batch_size=self.batch_size, shuffle=False, drop_last = True)
    test_loader = DataLoader(test_subset, batch_size=self.batch_size, shuffle=False, drop_last = True)
