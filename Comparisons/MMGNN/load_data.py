...
from construct import get_Pearson_fc,get_BOLD_feature,get_Degree_fc,get_sc,get_sc_feature,get_dataloader, get_fc_edgeWeight, get_sc_dataloader, get_fc_dataloader, get_fc_region_features
    ...
    def __init__(self, args):
        ...
        for label_files in label_list:
            ...
            for files in list:
                ...
                subj_fc_feature = get_fc_region_features(fc_region_features,
                                                         args) 
                # 构造fc Data
